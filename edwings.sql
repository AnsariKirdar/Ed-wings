...
id`,
`continents
`, `description`, `c_by`, `e_by`, `c_date`) VALUES
...
id`,
`continents
`, `country`, `description`, `c_by`, `e_by`, `c_date`) VALUES
...
(20) DEFAULT NULL,
  `email` varchar
(255) DEFAULT NULL,
  `travel_again` varchar
(3) DEFAULT NULL,
  `recommend_friends` varchar
(3) DEFAULT NULL,
...
`destination_visited`,
`departure_date
`, `telephone`, `mobile`, `email`, `travel_again`, `recommend_friends`, `suggestions`, `ip`, `c_date`) VALUES
...
id`,
`title
`, `thumb`, `full_img`, `u_by`, `e_date`, `c_date`) VALUES
...
id`,
`name
`, `username`, `password`, `email`, `f_password`, `type`, `trys`, `trys_out`, `c_date`) VALUES
...
id`,
`title
`, `description`, `link`, `link_text`, `file`, `c_by`, `e_by`, `c_date`) VALUES
