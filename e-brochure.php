    ...
    if ($result) {
      ...
      while ($row = mysqli_fetch_assoc($result)) {
        ...
        <div class="p-2" style="background-color: rgba(255, 255, 255, .4); border:3px solid rgba(0,0,0,0.2); border-radius: 15px;">
          ...
          <button type="button" class="btn btn-sm rounded-pill btn-primary px-4 font-weight-bold my-2" data-toggle="modal" data-target="#modelId">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Pelase Provide the Details to Download this </h5>
          ...
          <div class="modal-body">
            <form action="#" method="post">
              <div class="form-group">
                ...
                <input id="my-input" class="form-control" type="text" name="" required>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="my-input">Conatct No</label>
                <input id="my-input" class="form-control" type="text" name="" required>
              </div>
            </form>
          </div>
          <div class="modal-footer">
            ...
            <a class="btn btn-Primary" href="./img/brochure/<?php echo $b_file; ?>"
               download="ed-wings.com-tours-<?php echo $b_tile; ?>.pdf" data-dismiss="modal">
              Save
            </a>
          </div>
        </div>
