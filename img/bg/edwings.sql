...
--
-- Truncate table before insert `brochure`
--

TRUNCATE TABLE `brochure`;
--
...
--
-- Truncate table before insert `itinerary`
--
...
--
-- Truncate table before insert `news_letter`
--

TRUNCATE TABLE `news_letter`;
-- --------------------------------------------------------
...
--
-- Table structure for table `user_unverified`
--

DROP TABLE IF EXISTS `user_unverified`;
CREATE TABLE `user_unverified` (
  `id` int(11) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `username` varchar(255) DEFAULT NULL,
  `password` longtext DEFAULT NULL,
...
--
-- Truncate table before insert `user_unverified`
--

TRUNCATE TABLE `user_unverified`;
-- --------------------------------------------------------
...
--
-- Indexes for table `user_unverified`
--
...
--
-- AUTO_INCREMENT for table `user_unverified`
--
ALTER TABLE `user_unverified`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
